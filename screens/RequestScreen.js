...
const RequestScreen = () => {
    ...
    return (
        <SafeAreaView style={tw('top-8 p-3')}>
            ...
            <Text style={tw('text-2xl font-bold')}>Choose your Phone's brand</Text>
            
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Samsung')}>
                <Image 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Apple')}>
                <Image 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Huawei')}>
                <Image 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Tecno')}>
                <Image 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Infinix')}>
                <Image 
                style={tw('absolute top-0 h-10 w-40 ')} 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Oppo')}>
                <Image 
                style={tw('absolute top-0 h-10 w-40 ')} 
            ...
            <View style={tw('bg-white-200 w-full h-20 justify-between ')}>
                <TouchableOpacity style={tw('absolute p-4 w-full h-20 items-center p-2')} onPress={() => navigation.navigate('Nokia')}>
                <Image 
            ...
            <TouchableOpacity 
                ...
                style={tw('items-center justify-center rounded-full w-full h-16 bg-gray-200')} onPress={() => navigation.navigate('OtherPhones')}>
